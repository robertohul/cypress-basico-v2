...
describe('Central de Atendimento ao Cliente TAT', function(){
    ...
    it ('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', function(){
        cy.get('#firstName').type('Teste')
        cy.get('#lastName').type('da Silva')
        cy.get('#email').type('testex')
        cy.get('#open-text-area').type('dasdasd')
        cy.contains('button', 'Enviar').click()

        cy.get('.error').should('be.visible')
    })

    it ('campo telefone continua vazio quando preenchidio com valor não-numérico', function(){
        cy.get('#phone')
            .type('dasdsadas')
            .should('have.value', '')
    })
    ...
    it('exibe mensagem de erro quando o telefone se torna obrigatório mas não é preenchido antes do envio do formulário', function(){
        cy.get('#firstName').type('Teste')
        cy.get('#lastName').type('da Silva')
        cy.get('#email').type('testex@a.com')
    ...
    it('existe um formulário com sucesso usando um comando customizado', function(){
